...
import styles from '@terkplumber-ui-styles/flip-card/styles.module.css';
      ...
      >
        <div className={styles.content__front}>
          <div className={styles.flipCard__inner}>
            ...
            />
            <span
              data-testid="title-data"
              className={styles.contentFront__title}
            >
              {title}
            </span>
            <div
              data-testid="competences-data"
              className={styles.contentFront__competences}
            >
              {competences}
            </div>
            <div className={styles.flipCard__detailsLink} onClick={handleClick}>
              <CustomLink className={styles.contentFront__details}>
                details
              </CustomLink>
              <svg
